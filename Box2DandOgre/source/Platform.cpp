...
Platform::Platform(Ogre::SceneManager* sceneManager,b2Vec2 p1, b2Vec2 p2)
{
	...
	planeName += Ogre::StringConverter::toString(entityId_);
	planeMeshName += Ogre::StringConverter::toString(entityId_);
	planeEntityName += Ogre::StringConverter::toString(entityId_);
